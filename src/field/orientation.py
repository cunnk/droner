...
orientation_deg : float
    Estimated strip alignment angle in [0, 175] degrees (rounded to 5deg).
confidence : float
...
def estimate_orientation_deg(
    ...
    n_bins : histogram resolution (default 36 -> 5deg bins)
    """
    ...
    # Round to nearest 5deg to match the UI slider step
